  ...
  "education": [
    {
      ...
      "duration": null, // Source JSON did not provide duration
      "description": "Gurgaon, India" // Using location from source as description
    }
  ],
  "certifications": [
    {
      ...
      "accent": null // Source JSON did not provide accent
    },
    {
      "id": 2,
      "title": "IOT",
  ...
  "achievements": [
    {
      ...
      "description": null // Source JSON provided flat list, no separate description
    },
    {
      "id": 2,
